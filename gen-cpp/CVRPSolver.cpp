...
CVRPSolver_solveCVRPTWPD_args::~CVRPSolver_solveCVRPTWPD_args() throw() {
}


uint32_t CVRPSolver_solveCVRPTWPD_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t CVRPSolver_solveCVRPTWPD_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("CVRPSolver_solveCVRPTWPD_args");
...
CVRPSolver_solveCVRPTWPD_pargs::~CVRPSolver_solveCVRPTWPD_pargs() throw() {
}


uint32_t CVRPSolver_solveCVRPTWPD_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("CVRPSolver_solveCVRPTWPD_pargs");
...
CVRPSolver_solveCVRPTWPD_result::~CVRPSolver_solveCVRPTWPD_result() throw() {
}


uint32_t CVRPSolver_solveCVRPTWPD_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t CVRPSolver_solveCVRPTWPD_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("CVRPSolver_solveCVRPTWPD_result");
...
CVRPSolver_solveCVRPTWPD_presult::~CVRPSolver_solveCVRPTWPD_presult() throw() {
}


uint32_t CVRPSolver_solveCVRPTWPD_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CVRPSolverClient::recv_solveCVRPTWPD(std::vector<std::vector<int64_t> > & _return)
{
  ...
  CVRPSolver_solveCVRPTWPD_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void CVRPSolverProcessor::process_solveCVRPTWPD(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("CVRPSolver.solveCVRPTWPD", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "CVRPSolver.solveCVRPTWPD");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "CVRPSolver.solveCVRPTWPD");
  }

  CVRPSolver_solveCVRPTWPD_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "CVRPSolver.solveCVRPTWPD", bytes);
  }

  CVRPSolver_solveCVRPTWPD_result result;
  try {
    iface_->solveCVRPTWPD(result.success, args.vec, args.demands, args.v_caps, args.timeWindows, args.serviceTime, args.pickups, args.delivs);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "CVRPSolver.solveCVRPTWPD");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "CVRPSolver.solveCVRPTWPD");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "CVRPSolver.solveCVRPTWPD", bytes);
  }
}
...
void CVRPSolverConcurrentClient::solveCVRPTWPD(std::vector<std::vector<int64_t> > & _return, const std::vector<std::vector<int64_t> > & vec, const std::vector<int64_t> & demands, const std::vector<int64_t> & v_caps, const std::vector<std::vector<int64_t> > & timeWindows, const std::vector<int64_t> & serviceTime, const std::vector<int64_t> & pickups, const std::vector<int64_t> & delivs)
{
  int32_t seqid = send_solveCVRPTWPD(vec, demands, v_caps, timeWindows, serviceTime, pickups, delivs);
  recv_solveCVRPTWPD(_return, seqid);
}

int32_t CVRPSolverConcurrentClient::send_solveCVRPTWPD(const std::vector<std::vector<int64_t> > & vec, const std::vector<int64_t> & demands, const std::vector<int64_t> & v_caps, const std::vector<std::vector<int64_t> > & timeWindows, const std::vector<int64_t> & serviceTime, const std::vector<int64_t> & pickups, const std::vector<int64_t> & delivs)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("solveCVRPTWPD", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CVRPSolverConcurrentClient::recv_solveCVRPTWPD(std::vector<std::vector<int64_t> > & _return, const int32_t seqid)
{
